...
public class ElevatorCommand extends CommandBase {
  ...
  @Override
  public void execute() {
    if(drive_controller.getRawAxis(4) > 0.1)climber_Elevator_Subsystem.elevator_Up(drive_controller.getRawAxis(4));
    else if(drive_controller.getRawAxis(3) > 0.1)climber_Elevator_Subsystem.elevator_Up(-drive_controller.getRawAxis(3));
